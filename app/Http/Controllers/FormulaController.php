...
class FormulaController extends Controller
{
            ...
            ->when($keyword !== '', function ($query) use ($keyword) {
                $query->where(function ($query) use ($keyword) {
                    $query->where('nama_formula', 'like', "%{$keyword}%")
                        ->orWhereHas('barangJadi', function ($query) use ($keyword) {
    ...
    private function formData(Formula $formula): array
    {
        return [
            ...
            'barangBahans' => Barang::whereIn('jenis_barang', ['bahan_baku', 'bahan_penolong'])->orderBy('nama_barang')->get(),
        ];
    }
    ...
    private function validatedData(Request $request, ?Formula $formula = null): array
    {
        ...
        return $request->validate([
            ...
            'barang_bahan_id.*' => [
                ...
                'integer',
                'distinct',
                Rule::exists('barangs', 'id')->whereIn('jenis_barang', ['bahan_baku', 'bahan_penolong']),
            ],
